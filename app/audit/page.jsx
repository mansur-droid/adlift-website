...
export default function AuditPage(){
  return <main className="audit-page">
    ...
    <header className="nav"><a className="logo" href="/" aria-label="AdLift home"><img className="brand-logo" src="/adlift-icon.png" alt="AdLift" /></a><a className="nav-cta" href="https://calendly.com/mansur-adlift/30min?back=1&month=2025-11&date=2025-11-24" target="_blank" rel="noopener noreferrer">Book call</a></header>
